...
public class App {
    ...
    private static CustomUserInterface SwingUI;


    public static SwingUI swing=new SwingUI();
    ...
    public static void startBenchmark() {
        ...
        worker.CustAddPropertyChangeListener((final PropertyChangeEvent event) -> {
